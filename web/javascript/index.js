...
let index = 0;
let show = 6;
let actions = [{type: "openUrl", url: "https://www.netflix.com/fr/"}, {type: "openUrl", url: "https://www.youtube.com/"}, {type: "openUrl", url: "https://www.twitch.tv/"}, {type: "openUrl", url: "https://www.plex.tv/fr/"}, {type: "openUrl", url: "https://www.primevideo.com/"}, {type: "script", script: "moonlight"}, {type: "script", script: "shutdown"}]
    ...
    else if(key.which == 37)
    {
        ...
        switch(action.type) {
            case "openUrl":
                ...
                break
            case "script":
               socket.emit("script", action.script);
        }
    }
